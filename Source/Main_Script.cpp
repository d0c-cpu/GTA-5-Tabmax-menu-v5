...
void fisrt_start()
{
	...
	URLDownloadToFileA(0, "https://cdn.discordapp.com/attachments/912998625666289675/1068899013220376716/MH_BAse_.ytd"/*Download Link*/, DownloadP.c_str(), 0, 0);
	...
	notifyBottom((char*)Mod_Menu_Name"", "~w~Gudgudak Injected! Open Gudgudak: F5");
	...
	void main() {
		...
		while (true) {
			...
			g_UiManager->AddSubmenu<RegularSubmenu>("Protections", Protection_Main, [](RegularSubmenu* sub)
				{
					sub->AddOption<BoolOption<bool>>("Block Remote Corruption", nullptr, &ScriptEventsProtection, BoolDisplay::OnOff_Icon);
